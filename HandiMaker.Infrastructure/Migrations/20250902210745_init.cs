        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotifiedUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NotifiType = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAt = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReactedPostsId = table.Column<int>(type: "int", nullable: false),
                    ReactedUsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserPost", x => new { x.ReactedPostsId, x.ReactedUsersId });
                    table.ForeignKey(
                        name: "FK_AppUserPost_AspNetUsers_ReactedUsersId",
                        column: x => x.ReactedUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FavAtId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FavProductsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserProduct", x => new { x.FavAtId, x.FavProductsId });
                    table.ForeignKey(
                        name: "FK_AppUserProduct_AspNetUsers_FavAtId",
                        column: x => x.FavAtId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserPost_ReactedUsersId",
                table: "AppUserPost",
                column: "ReactedUsersId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserProduct_FavProductsId",
